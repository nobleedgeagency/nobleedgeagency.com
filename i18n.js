...
(function() {
  ...
  const translations = {
    ...
    "testimonials.subtitle": "They trusted us. Here's what they think.",
    "testimonials.1.name": "Sophie M.",
    "testimonials.1.role": "Restaurant Owner, Lyon",
    "testimonials.1.text": "Since Noble Edge took over our social media, our restaurant is almost fully booked every weekend. Strategy, reactivity and creativity - I recommend them blindfolded.",
    "testimonials.2.name": "Thomas R.",
    "testimonials.2.role": "Founder, Fashion E-commerce",
    "testimonials.2.text": "In 2 months, our engagement increased 4x. The team truly understands our industry and our content finally looks like our brand.",
    "testimonials.3.name": "Amelie D.",
    "testimonials.3.role": "Business Coach, Paris",
    "testimonials.3.text": "I tried managing my social media myself but I had neither the time nor the skills. Now I generate qualified leads every week.",
    "testimonials.4.name": "Karim B.",
    "testimonials.4.role": "Director, SME Construction",
    "testimonials.4.text": "A complete audit, clear objectives and a precise action plan. 4 months later, our digital presence is unrecognizable. Excellent investment.",
    // FAQ Section
    "faq.label": "FAQ",
    "faq.title": "Frequently Asked Questions",
    "faq.subtitle": "Everything you want to know about our agency.",
    "faq.1.q": "Which social media platforms do you manage?",
    "faq.1.a": "We manage Instagram, Facebook, LinkedIn, TikTok, YouTube Shorts, Pinterest and X.",
    "faq.2.q": "Do you work with all industries?",
    "faq.2.a": "Yes. Restaurants, e-commerce, real estate, healthcare, fashion, B2B services, coaching, crafts, tourism, tech startups...",
    "faq.3.q": "How does your custom offer work?",
    "faq.3.a": "During our discovery call, we analyze your needs, objectives and budget. We then build a personalized proposal tailored to your situation.",
    "faq.4.q": "Do you also create visuals and copy?",
    "faq.4.a": "Absolutely. Visuals, carousels, Reels, captions, scripts - we handle all production. You just need to approve.",
    "faq.5.q": "How does the first meeting work?",
    "faq.5.a": "A free 30-minute discovery call. We understand your situation and objectives, then prepare a custom proposal within 48 hours. No commitment.",
    "faq.6.q": "Do you also do paid advertising?",
    "faq.6.a": "Yes. Meta Ads, Google Ads, TikTok Ads - strategy, visual creation, setup, targeting, budget and continuous optimization.",
    "faq.7.q": "Is there a minimum commitment?",
    "faq.7.a": "Our missions have no minimum commitment. We recommend 3 months however to see significant results.",
    // Contact / CTA Section
    "contact.label": "TAKE ACTION",
    "contact.title": "Ready to Transform\n Your Digital Presence?",
    "contact.subtitle": "Tell us about your project. We'll respond within 24 hours.",
    "contact.cta.label": "Why Contact Us?",
    "contact.cta.1": "Free Call & No Commitment",
    "contact.cta.2": "Response Within 24 Hours",
    "contact.cta.3": "Personalized Proposal",
    "contact.cta.4": "Human Support",
    "contact.form.title": "Tell Us About Your Project",
    "contact.form.firstname": "First Name",
    "contact.form.firstnamePhrase": "First Name *",
    "contact.form.lastname": "Last Name",
    "contact.form.lastnamePhrase": "Last Name *",
    "contact.form.email": "Work Email",
    "contact.form.emailPhrase": "Work Email *",
    "contact.form.company": "Company",
    "contact.form.service": "Which service interests you?",
    "contact.form.message": "Describe your project",
    "contact.form.messagePhrase": "Describe your project *",
    ...
    "footer.desc": "Marketing and communication agency specializing in community management, digital strategy and content creation.",
    "footer.nav.label": "Navigation",
    "footer.nav.sections": "Sections",
    "footer.nav.contact": "Contact",
    "footer.social.label": "Social Media",
    "footer.copyright": "© 2026 Noble Edge Agency. All rights reserved.",
    // Cookie Banner
    "cookie.banner.h3": "Cookie Preferences",
    "cookie.banner.p": "We use strictly necessary cookies for site functionality, and analytics cookies to improve our services. By clicking Accept, you consent to their use. You can manage your choices at any time.",
    "cookie.banner.btn.refuse": "Refuse",
    "cookie.banner.btn.settings": "Settings",
    "cookie.banner.btn.accept": "Accept",
    "cookie.settings.h3": "Cookie Preferences",
    "cookie.settings.p": "You can personalize your cookie choices at any time.",
    "cookie.settings.necessary.h4": "Necessary Cookies",
    "cookie.settings.necessary.p": "Essential for site functionality. Cannot be disabled.",
    "cookie.settings.analytics.h4": "Statistics Cookies",
    "cookie.settings.analytics.p": "Help us understand site usage.",
    "cookie.settings.personalization.h4": "Personalization Cookies",
    "cookie.settings.personalization.p": "Allow us to personalize your experience.",
    "cookie.settings.btn.cancel": "Cancel",
    "cookie.settings.btn.save": "Save"
}
    },
    // Testimonials Section
    ...
    "footer.en.copyright": "© 2026 Noble Edge Agency. All rights reserved.,
      "cookie.banner.h3": "Cookies",
      "cookie.banner.p": "Nous utilisons des cookies strictement nécessaires au fonctionnement du site, et, avec votre accord, des cookies de mesure d’audience ou de personnalisation. Vous pouvez accepter, refuser ou paramétrer vos choix à tout moment.",
      "cookie.banner.btn.refuse": "Refuser",
      "cookie.banner.btn.settings": "Paramétrer",
      "cookie.banner.btn.accept": "Accepter",
      "cookie.settings.h3": "Préférences cookies",
      "cookie.settings.p": "Vous pouvez personnaliser vos choix. Les cookies nécessaires restent actifs pour faire fonctionner le site.",
      "cookie.settings.necessary.h4": "Cookies nécessaires",
      "cookie.settings.necessary.p": "Indispensables au fonctionnement du site et toujours actifs.",
      "cookie.settings.analytics.h4": "Cookies de mesure d’audience",
      "cookie.settings.analytics.p": "Nous aident à comprendre l’utilisation du site et à l’améliorer.",
      "cookie.settings.personalization.h4": "Cookies de personnalisation",
      "cookie.settings.personalization.p": "Permettent d’adapter certains contenus ou outils embarqués.",
      "cookie.settings.btn.cancel": "Annuler",
      "cookie.settings.btn.save": "Enregistrer"
  }
};
